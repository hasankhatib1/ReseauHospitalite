...
<link rel='stylesheet' media='screen' href="<?= $this->assetUrl('./css/css_agenda/cupertino/jquery-ui.min.css')?>" />
<link rel='stylesheet' media='screen' href="<?= $this->assetUrl('./css/css_agenda/fullcalendar.min.css')?>" />

<link rel='stylesheet' media='print' href="<?= $this->assetUrl('./css/css_agenda/fullcalendar.print.min.css')?>" />

<link rel="stylesheet" href="<?= $this->assetUrl('./css/bootstrap.min.css')?>">

<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/moment.min.js')?>"> </script>
<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/jquery.min.js')?>">  </script>

<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/fullcalendar.min.js')?>"> </script>

<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/fr.js')?>"> </script> <!-- c'est pour la langue française dans la affichage -->

<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/gcal.js')?>"> </script> 

<script src="<?= $this->assetUrl('js/bootstrap.min.js')?>"> </script>

<script type="text/javascript" src= " <?= $this->assetUrl('./js/js_agenda/script_agenda.js')?>"> </script>
	    	...
	    	<div class="modal-dialog">
	      		<div class="modal-content">   <!-- Modal content-->
	        		...
	        		<div class="modal-footer"> <!-- Modal Footer-->
	          			...
	          			<!-- <input type="hidden" name="operation" value="supprimer">   info pour préciser l'action que l'admin veut réaliser -->

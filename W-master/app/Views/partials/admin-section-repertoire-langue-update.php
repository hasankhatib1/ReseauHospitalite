...
if (!empty($tabResult))   // recuperer les informations de la structure de langue
{
	...
	$tel		     = $tabResult["tel"] ;
	$mail 			 = $tabResult["mail"] ;
	$nomPec       	 = $tabResult["nomPec"] ;
	$telPec	         = $tabResult["telPec"] ;
	$mailPec         = $tabResult["mailPec"] ;
	    				...
	    				<div class="modal-dialog modal-lg" >
	      					<div class="modal-content">   <!-- Modal content-->
	        					...
	        					<div class="modal-body"> <!-- Modal Body-->
									...
									<label class="col-sm-2 control-label"> Nom de structure </label>
									<div class="col-sm-10 ">
										<input type="text" name="structure" placeholder="Nom de structure" required class="form-control"  value="<?php echo $structure ?>" > <br/>
									</div>
									...
									<label class="col-sm-2 control-label"> Personne(s) en contact </label>
									<div class="col-sm-10 ">
										<input type="text" name="nomPec" placeholder="Personne(s) en contact"  class="form-control" value="<?php echo $nomPec ?>"> <br/>
									</div>

									<label class="col-sm-2 control-label"> Téléphone </label>
									<div class="col-sm-10 ">
										<input type="tel" name="telPec" placeholder="Téléphone"  class="form-control"  value="<?php echo $telPec ?>"> <br/>
									</div>

									<label class="col-sm-2 control-label"> Mail </label>
									<div class="col-sm-10 ">
										<input type="mail" name="mailPec" placeholder="Mail"  class="form-control" value="<?php echo $mailPec ?>"> <br/>
									</div>

									<label class="col-sm-2 control-label"> Type de formation </label>
									<div class="col-sm-10 ">
										<input type="text" name="formation" placeholder="Type de formation FLE/FLI/Alpha" required class="form-control" value="<?php echo $formation ?>"> <br/>
									</div>

									<label class="col-sm-2 control-label"> Cotisation et publique </label>
									<div class="col-sm-10 ">
										<input type="text" name="cotisation" placeholder="Cotisation et type publique" required class="form-control" value="<?php echo $cotisation ?>"> <br/>
									</div>
